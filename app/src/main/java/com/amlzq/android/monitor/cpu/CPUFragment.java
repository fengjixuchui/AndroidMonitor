package com.amlzq.android.monitor.cpu;
...
public class CPUFragment extends Fragment {
    ...
    /**
     * mBuildInfo.append("CPU_ABI(CPU和ABI的本地代码指令集)==" + Build.CPU_ABI + "\n");
     * mBuildInfo.append("CPU_ABI2(CPU和ABI的本地代码指令集2)==" + Build.CPU_ABI2 + "\n");
     */
     ...
     * @return A new instance of fragment CPUFragment.
     */
